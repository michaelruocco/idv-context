...
import uk.co.idv.method.adapter.json.otp.delivery.LastUpdatedConfigMixin;
import uk.co.idv.method.adapter.json.otp.policy.delivery.phone.simswap.SimSwapConfigModule;
import uk.co.idv.method.adapter.json.otp.policy.delivery.phone.sms.SmsDeliveryMethodConfigDeserializer;
import uk.co.idv.method.adapter.json.otp.policy.delivery.phone.voice.VoiceDeliveryMethodConfigDeserializer;
