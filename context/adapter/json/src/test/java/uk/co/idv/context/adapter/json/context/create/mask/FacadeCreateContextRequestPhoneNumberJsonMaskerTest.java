...
class FacadeCreateContextRequestPhoneNumberJsonMaskerTest {

    private static final ObjectMapper MAPPER = ObjectMapperFactory.build(new CreateContextModule());

    private final JsonMasker masker = new FacadeCreateContextRequestPhoneNumberJsonMasker(MAPPER);
    ...
    void shouldMaskEmailAddressesInRequest() {
        ...
        assertThatJson(maskedJson).isEqualTo(FacadeCreateContextRequestJsonMother.withMaskedChannelPhoneNumbers());
    }
