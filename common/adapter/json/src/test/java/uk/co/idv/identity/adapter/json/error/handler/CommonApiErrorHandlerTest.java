...
import uk.co.idv.identity.adapter.json.error.badrequest.BadRequestError;

import java.util.Optional;

import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.Mockito.mock;
import static uk.co.idv.identity.adapter.json.error.handler.JsonParseExceptionMother.buildJsonParseException;
